...
export default function UploadForm() {
    ...
    return (
        ...
        >
            ...
            <p className="text-black text-center text-xs pb-2">we can only classify <b>fennec fox, sand cat, meerkat</b>, and <b>prairie dog</b> for the time being</p>

            <label
                htmlFor="fileInput"
                className={`flex flex-col items-center gap-3 rounded-lg border-2 border-dashed p-8 text-center text-sm text-slate-600 transition-colors ${dragOver ? "border-blue-600 bg-blue-50" : "border-slate-300"
                    }`}
